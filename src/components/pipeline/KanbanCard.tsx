...
import { Check, MoreHorizontal, Trash2, TriangleAlert } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 text-xs">
        <span className="text-text-muted">{copy.pipeline.card.valueLabel}</span>
              ...
              <div className="flex-1">
                ...
                <AlertDialog.Description className="mt-2 text-sm text-text-secondary">
                  {copy.pipeline.deleteDialog.description(
                    CURRENCY_FORMATTER.format(opportunity.value),
