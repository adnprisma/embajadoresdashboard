...
export const copy = {
  ...
  tareas: {
    ...
    // Tablero de /tareas (bloque 4) — columnas por día, tarjetas con
    // control de tres estados. "Vencidas" siempre visible aunque esté
    // vacía (esa ausencia es información); "Fin de semana" y "Sin fecha"
    // solo aparecen si tienen algo, para no ser espacio muerto.
    board: {
      previousWeek: "Semana anterior",
      nextWeek: "Semana siguiente",
      currentWeek: "Esta semana",
      overdueColumn: "Vencidas",
      weekendColumn: "Fin de semana",
      noDateColumn: "Sin fecha",
      columnCount: (total: number, done: number) => `${total} · ${done} hechas`,
      moveToLabel: "Mover a…",
      editTask: "Editar tarea",
      statusControlLabel: "Estado de la tarea",
      statusLabels: {
        pending: "Pendiente",
        in_progress: "En proceso",
        done: "Hecha",
      },
      statusUpdateSuccessToast: "Tarea actualizada.",
      statusUpdateErrorToast: "No pudimos actualizar la tarea. Intenta de nuevo.",
      taskUpdatedToast: "Tarea actualizada.",
      moveErrorToast: "No pudimos mover la tarea. Intenta de nuevo.",
      dayEmpty: "Sin tareas este día.",
      today: "Hoy",
    },
    dialog: {
  ...
  perfil: {
    ...
    prices: {
      intro:
        "Los precios con los que cotizas paquetes, ADN y productos. Lo que no cambies aquí sigue el precio de catálogo de Prisma — y así se queda mientras no lo toques.",
      catalogLabel: "Catálogo",
      sectionPaquetes: "Paquetes",
      sectionAdn: "ADN",
      sectionProductos: "Productos",
      submit: "Guardar cambios",
      submitLoading: "Guardando…",
      noChanges: "Sin cambios por guardar.",
      successToast: (n: number) => (n === 1 ? "1 precio actualizado." : `${n} precios actualizados.`),
